	...
	if (!mysqli_stmt_prepare($stmt,$sql)) {
		...
		die(); 
			...
			if ($row['status'] == 0) {
				...
				<img name='userPostProImg' id='VAGprofilepic' class='rounded-circle border border-secondary' src='ProfilePictures/Default.jpg'>";
				...
				echo "
				<h3 id='VAGprofilename'>".$username."</h3> 
				<img id='VAGprofilepic' class='rounded-circle border border-secondary' src='ProfilePictures/$userProfilePic'>";
