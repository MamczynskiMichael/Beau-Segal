...
function displayProfInfo(){
	...
	echo '
	<button type="button" class="btn btn-primary float-right" data-bs-toggle="modal" data-bs-target="#editprofile">Edit Profile</button>
	';
}
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group">
              <input type="file" class="form-control" id="inputGroup" name="userPostProImg">
              <label class="input-group-text" for="inputGroup" aria-describedby="inputGroup">Select an profile image</label>
